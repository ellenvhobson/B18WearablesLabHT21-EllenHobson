...
options.acc_threshold = 0.1*G;  % set the moving average acceleration threshold value to 10% of gravity
options.ssd_threshold = 0.1*G;  % set the moving average accel threshold to 10% of gravity
...
%-------------------------------------------------------------------------%
options.MinPeakDistance = 0.2;    % 0.2s
options.MinPeakHeight = 0.05*G;      % set to 5% of gravity [m/s^2]
